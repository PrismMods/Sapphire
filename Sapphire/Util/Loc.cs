    ...
    internal static class Loc
    {
        ...
        private static readonly Dictionary<string, string> Ko = new Dictionary<string, string>
        {
            ...
            ["Shift+G — angle pad: space-separated RELATIVE angles (180 = straight; math ok), Place a whole run"]
                = "Shift+G — 각도 패드: 공백으로 구분한 상대 각도를 입력해 (180 = 직진, 수식 가능) 한 번에 배치합니다",
            ...
            ["Copy"] = "복사",
            ["Cut"] = "잘라내기",
            ["Copy (select events)"] = "복사 (이벤트 선택)",
            ["Cut (select events)"] = "잘라내기 (이벤트 선택)",
            ["Paste"] = "붙여넣기",
            ["Delete"] = "삭제",
            ["Rotate CW"] = "시계 방향 회전",
            ...
            ["Duplicate"] = "복제",
            ["Move"] = "이동",
            ["Not wired up yet"] = "아직 연결되지 않았습니다",
            ["Re-analyse"] = "다시 분석",
            ["Analysing…"] = "분석 중…",
            ["Advanced"] = "고급",
            ["Window (s)"] = "창 길이 (초)",
            ...
            ["Tempo bins"] = "템포 분할 수",
            ["Reset"] = "초기화",
            ["Re-analyse to apply."] = "다시 분석해야 적용됩니다.",
            ["Changes apply straight away."] = "변경하면 바로 적용됩니다.",
            ["Auto"] = "자동",
            ...
            ["tempo change"] = "템포 변화",
            ["to check"] = "확인 필요",
            ["Showing: to check"] = "표시: 확인 필요",
            ["Showing: all changes"] = "표시: 모든 변화",
            ["Rescan"] = "다시 검사",
            ["(no speed changes)"] = "(속도 변화 없음)",
            ["song"] = "노래",
            ["song —"] = "노래 —",
            ["How much audio each reading spans. The graph cannot resolve a change shorter than this. Longer reads steadier and more precisely.   ·   1-30, default 8"] = "읽기 하나가 담는 오디오 길이입니다. 이보다 짧은 변화는 그래프가 잡아내지 못합니다. 길수록 더 안정적이고 정밀하게 읽습니다.   ·   1~30, 기본값 8",
            ["How often a reading is taken. Denser graph, slower analysis — but it does not sharpen a change; the window does.   ·   0.5-10, default 3"] = "읽기 간격입니다. 그래프가 촘촘해지고 분석은 느려지지만, 변화가 뚜렷해지지는 않습니다. 그건 창 길이가 정합니다.   ·   0.5~10, 기본값 3",
            ["What a small tempo change costs the graph. High holds one line through noise but commits to a real shift late; low reacts promptly and also follows noise. Typing here turns Auto off.   ·   0-200, default 12"] = "작은 템포 변화에 드는 비용입니다. 높으면 잡음을 잘 버티지만 실제 변화를 늦게 따라가고, 낮으면 빠르게 반응하는 대신 잡음도 따라갑니다. 여기에 입력하면 자동이 꺼집니다.   ·   0~200, 기본값 12",
            ["Octave cost"] = "옥타브 비용",
            ["Extra cost for a jump bigger than 1.35x — an octave flip rather than a tempo change. This is what lets Smoothness stay low enough to catch a shift promptly without the line hopping between half and double.   ·   0-200, default 36"] = "1.35배가 넘는 도약에 붙는 추가 비용입니다. 템포 변화가 아니라 옥타브가 뒤집히는 경우이기 때문입니다. 덕분에 매끄러움을 낮게 두어 변화를 빨리 잡으면서도 선이 절반과 두 배 사이를 오가지 않습니다.   ·   0~200, 기본값 36",
            ["How finely 60-480 BPM is split. A reading is a bin centre, so this is the precision floor: 224 steps 0.94%, 448 steps 0.47%, 896 steps 0.23%. 448 is the knee — doubling it costs double for about two points.   ·   24-1024, default 448"] = "60~480 BPM을 얼마나 잘게 나눌지 정합니다. 읽기는 칸의 중심값이라 여기서 정밀도 하한이 정해집니다. 224칸 0.94%, 448칸 0.47%, 896칸 0.23% 간격입니다. 448칸이 분기점이고, 두 배로 늘리면 시간도 두 배 드는 대신 2%p 정도만 오릅니다.   ·   24~1024, 기본값 448",
            ["moves"] = "변화",
            ["steady"] = "일정",
            ["offset"] = "오프셋",
            ["Tempo"] = "템포",
            ["here"] = "현재",
            ["mapping tempo…"] = "템포 분석 중…",
            ["Tempo: unknown"] = "템포: 알 수 없음",
            ["(confident)"] = "(확실)",
            ["(steady)"] = "(일정)",
            ["(unsure)"] = "(불확실)",
            ["Tempo is too unclear to apply."] = "템포가 불확실해 적용하지 않습니다.",
            ["BPM set to"] = "BPM을 다음 값으로 설정했습니다:",
            ["shown"] = "표시 중",
            ["AUDIO"] = "오디오",
            ["Reading the song…"] = "노래를 읽는 중…",
            ...
            ["Song waveform"] = "노래 파형",
            ["onset at"] = "첫 소리",
            ["nearest attack at"] = "가장 가까운 소리",
            ["nearest attack"] = "가장 가까운 소리",
            ["attack, on the beat grid"] = "박자 격자 위의 소리",
            ["snapped to the song's beat grid"] = "노래의 박자 격자에 맞췄습니다",
            ["No attack near the current offset."] = "현재 오프셋 근처에서 소리를 찾지 못했습니다.",
            ["Offset is past the analysed head — no suggestion."] = "오프셋이 분석 구간을 넘어서 추천할 수 없습니다.",
            ["Song samples unavailable."] = "노래 샘플을 읽을 수 없습니다.",
            ["No clear onset found."] = "뚜렷한 첫 소리를 찾지 못했습니다.",
            ["Level has no tiles yet."] = "아직 타일이 없습니다.",
            ["VFX"] = "시각 효과",
            ["Modifiers"] = "수정",
            ["Conveniences"] = "편의 기능",
            ["DLC"] = "DLC",
            ...
            ["Tray"] = "트레이",
            ["Drag events here from the event panel"] = "이벤트 패널에서 이벤트를 여기로 끌어다 놓으세요",
            ["Drag onto a tile · Shift replaces its events"] = "타일로 끌어다 놓기 · Shift를 누르면 그 타일의 이벤트를 교체합니다",
            ["Drag rows into the tray to keep them"] = "행을 트레이로 끌어다 놓아 보관합니다",
            ["Replace"] = "교체",
            ["Remove"] = "제거",
            ["Variables"] = "변수",
            ["events"] = "개 이벤트",
            ...
            ["keys"] = "개 키",
            ["host tile"] = "호스트 타일",
            ["Fix the errors first"] = "먼저 오류를 고치세요",
            ["A tile in the script is past the end of the level"] = "스크립트의 타일 번호가 레벨 끝을 넘습니다",
            ["Compiled"] = "컴파일됨",
            ["templates skipped (path/timing events can't be triggered)"] = "개 템플릿 건너뜀 (경로/타이밍 이벤트는 실행 중에 발동할 수 없습니다)",
            ["Removed compiled events"] = "컴파일된 이벤트를 제거했습니다",
            ["Write the script into the level as ordinary events (replaces the previous output)"] = "스크립트를 일반 이벤트로 레벨에 기록합니다 (이전 결과를 대체합니다)",
            ["Delete the compiled events and switch the templates back on"] = "컴파일된 이벤트를 지우고 템플릿을 다시 켭니다",
            ["Show the language reference"] = "언어 참고 표시",
            ["Runs in the unmodded game: compiles to SetInputEvent / SetConditionalEvents"] = "모드 없는 게임에서 동작합니다: SetInputEvent / SetConditionalEvents로 컴파일됩니다",
            ["<b>Variables</b>   flag lights   ·   state mode = calm, wild   ·   counter hits 0..3 wrap   (optional  = start)\n<b>Keys</b>   on key Up:   (Up Down Left Right Action1 Action2 Confirm Any · add release / nohit)\n<b>Statements</b>   toggle lights   ·   mode = wild   ·   hits += 1   ·   run flash   ·   if hits == 3 and not lights:  …  else:\n<b>When</b>   when mode == wild:   run the tagged events each time the condition becomes true\n<b>Judgments</b>   on miss at 40:   run shake   (perfect earlyPerfect latePerfect veryEarly veryLate tooEarly tooLate barely hit miss loss checkpoint)\n<b>run tag</b> copies every event tagged `tag` onto the host tile (host 0 by default); those templates are switched off. Keys are also hits unless `nohit`. Test from the level's start."] = "<b>변수</b>   flag lights   ·   state mode = calm, wild   ·   counter hits 0..3 wrap   (선택: = 시작값)\n<b>키</b>   on key Up:   (Up Down Left Right Action1 Action2 Confirm Any · release / nohit 추가 가능)\n<b>문장</b>   toggle lights   ·   mode = wild   ·   hits += 1   ·   run flash   ·   if hits == 3 and not lights:  …  else:\n<b>When</b>   when mode == wild:   조건이 참이 될 때마다 태그된 이벤트를 실행합니다\n<b>판정</b>   on miss at 40:   run shake   (perfect earlyPerfect latePerfect veryEarly veryLate tooEarly tooLate barely hit miss loss checkpoint)\n<b>run 태그</b>는 `태그`가 붙은 모든 이벤트를 호스트 타일(기본값 host 0)로 복사하고, 원본 템플릿은 비활성화합니다. nohit가 없으면 키 입력도 타격으로 처리됩니다. 레벨 처음부터 테스트하세요.",
            ["This game version has no SetInputEvent"] = "이 게임 버전에는 SetInputEvent가 없습니다",
            ["SetInputEvent can't carry a tag in this game version, so a key can't switch states"] = "이 게임 버전의 SetInputEvent는 태그를 가질 수 없어 키로 상태를 바꿀 수 없습니다",
            ["Drag events here from the event panel — select several to take them all as one folder"] = "이벤트 패널에서 이벤트를 끌어다 놓으세요. 여러 개를 선택하면 한 폴더로 함께 옮겨집니다",
            ["Click to open · drag onto a tile · Shift replaces its events"] = "클릭해서 열기 · 타일로 끌어다 놓기 · Shift를 누르면 그 타일의 이벤트를 교체합니다",
            ["Click to edit · drag onto a tile"] = "클릭해서 편집 · 타일로 끌어다 놓기",
            ["Variable"] = "변수",
            ["Formula error"] = "수식 오류",
            ["Formulas that no longer evaluate"] = "계산할 수 없게 된 수식",
            ["Names use letters, digits and _, and must be unique"] = "이름은 영문자, 숫자, _만 쓸 수 있고 겹치지 않아야 합니다",
            ["Write $name in any number field. The level saves the numbers, so it plays without Sapphire; the formulas are kept for editing."] = "숫자 입력란 어디에나 $이름을 쓸 수 있습니다. 레벨에는 계산된 숫자가 저장되므로 Sapphire 없이도 플레이할 수 있고, 수식은 편집용으로 함께 보관됩니다.",
            ["error"] = "오류",
            ["field"] = "개 입력란",
            ["fields"] = "개 입력란",
        };
