            ...
            private void Update()
            {
                ...
                // left that chrome stranded on screen.
                {
                    ...
                    if (!_leftTabsReg)
                    {
                        ...
                        UI.PanelKit.RegisterTabbable(EditorScript.Kit, Loc.T("Script"), EditorScript.TabAvailable,
                            () => EditorScript.IsOpen, EditorScript.SetOpen);
                    }
                    bool rails = false;
                    try
                    {
